  ...
  return (
    <div className="app-container">
      <Sidebar 
        ...
        onTasksClick={() => setShowTaskManager(true)}
        onChatClick={() => setShowGeminiChat(true)}
      />
      ...
      {showTaskManager && <TaskManager onClose={() => setShowTaskManager(false)} />}
      {showGeminiChat && <GeminiChat 
